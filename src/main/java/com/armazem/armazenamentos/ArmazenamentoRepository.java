...
public interface ArmazenamentoRepository extends CrudRepository<Armazenamento, UUID> {
    ...
    @Query(value = "SELECT CAST(a.armazenamento_id AS VARCHAR) AS armazenamentoId, a.quantidade AS quantidade, g.nome AS nomegalpao, e.setor AS setorestoque, p.nome AS nomeproduto, p.descricao \n" +
